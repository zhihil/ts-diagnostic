...
import { IStudentViewModel, Gender, User, Profile, Address, EducationalBiography, IProfileViewModel } from "./models";
...
class StudentViewModel {
    ...
    constructor(model: Readonly<IProfileViewModel>) {
        ...
        this.getEducationalBio = lang.hitch(this, model.getEducationalBio);
    ...
    registerWatches(model: Readonly<IProfileViewModel>) {
        ...
        */
        ...
        model.watch("Courses", (_propName, _oldValue, newValue: string[]) => {
            this.Courses = newValue;
        });
        model.watch("SIN", (_propName, _oldValue, newValue: string) => {
            this.SIN = newValue;
        });
    }
...
export default dojo_declare([Stateful], StudentViewModel.prototype);