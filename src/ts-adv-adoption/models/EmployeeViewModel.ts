...
import { IEmployeeViewModel, Gender, User, Profile, Address, Contact, ProfessionalBiography, IProfileViewModel } from "./models";
...
export default dojo_declare([Stateful], EmployeeViewModel.prototype);