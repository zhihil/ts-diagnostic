...
import PersonalViewModel from "./PersonalViewModel";
import StudentViewModel from "./StudentViewModel";
import FlatEntityStore from "../stores/FlatEntityStore";
import { 
    Gender, 
    User, 
    Profile, 
...
import { IFlatEntityStore } from "../stores/stores";
...
export default dojo_declare([Stateful], ProfileViewModel.prototype);
