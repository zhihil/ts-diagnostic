...
import { IPersonalViewModel, Gender, User, Profile, Address, IProfileViewModel, LocationMeta, Biography } from "./models";
...
export default dojo_declare([Stateful], PersonalViewModel.prototype);
