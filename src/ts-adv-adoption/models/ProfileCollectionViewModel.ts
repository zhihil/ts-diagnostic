...
import { IProfileCollectionViewModel, IProfileViewModel, IProfileModel } from "./models";
...
export default dojo_declare([Stateful], ProfileCollectionViewModel.prototype);
