...
import SimpleQueryEngine from "dojo/store/util/SimpleQueryEngine";
import request from "dojo/request";
import { IFlatEntityStore, FlatEntity, IFlatEntityStoreCtorOptions, IFlatEntityStoreAddOptions } from "./stores";
...
export default dojo_declare(null, FlatEntityStore.prototype);